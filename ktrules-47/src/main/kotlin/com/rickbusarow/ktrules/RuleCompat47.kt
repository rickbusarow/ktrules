...
/** @since 1.1.1 */
public class RuleCompat47(private val ruleCompat: RuleCompat) :
  Rule(
  ...
  override val editorConfigProperties: List<KtLintEditorConfigProperty<*>>
    get() = ruleCompat.usesEditorConfigProperties.map { it.toKtLintProperty() }

  override fun beforeFirstNode(editorConfigProperties: EditorConfigProperties) {
    ruleCompat.beforeFirstNode(EditorConfigCompat47(editorConfigProperties))
