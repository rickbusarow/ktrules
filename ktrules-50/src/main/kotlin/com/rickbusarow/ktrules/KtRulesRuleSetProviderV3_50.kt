...
public class KtRulesRuleSetProviderV3_50 : RuleSetProviderV3(RuleSetId(KtRulesRuleSetProvider.ID)) {

  override fun getRuleProviders(): Set<RuleProvider> {

    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider50() }
  }
}

/** @since 1.1.1 */
public fun RuleProviderCompat.toKtLintRuleProvider50(): RuleProvider {
  return RuleProvider { RuleCompat50(createNewRuleInstance()) }
}
