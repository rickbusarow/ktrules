...
/** @since 1.1.1 */
public class EditorConfigCompat50(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty50()]
  }
...
/** @since 1.1.1 */
public fun <T> EditorConfigProperty<T>.toKtLintProperty50(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty50
