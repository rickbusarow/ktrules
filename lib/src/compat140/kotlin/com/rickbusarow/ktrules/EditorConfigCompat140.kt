...
/** */
class EditorConfigCompat140(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty140()]
  }
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty140(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty140
