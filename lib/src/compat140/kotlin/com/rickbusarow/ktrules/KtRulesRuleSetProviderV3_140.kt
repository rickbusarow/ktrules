...
class KtRulesRuleSetProviderV3_140 : RuleSetProviderV3(RuleSetId(KtRulesRuleSetProvider.ID)) {

  override fun getRuleProviders(): Set<RuleProvider> {

    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider140() }
  }
}

/** */
fun RuleProviderCompat.toKtLintRuleProvider140(): RuleProvider {
  return RuleProvider { RuleCompat140(createNewRuleInstance()) }
}
