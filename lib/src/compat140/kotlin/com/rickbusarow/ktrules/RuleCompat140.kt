...
/** */
class RuleCompat140(private val ruleCompat: RuleCompat) :
  Rule(
    ...
    usesEditorConfigProperties = ruleCompat.usesEditorConfigProperties
      .mapToSet { shimProperty -> shimProperty.toKtLintProperty140() }
  ) {

  override fun beforeFirstNode(editorConfig: EditorConfig) {
    ruleCompat.beforeFirstNode(EditorConfigCompat140(editorConfig))
