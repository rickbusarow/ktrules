...
class KtRulesRuleSetProviderV3_130 : RuleSetProviderV3(RuleSetId(KtRulesRuleSetProvider.ID)) {

  override fun getRuleProviders(): Set<RuleProvider> {

    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider130() }
  }
}

/** */
fun RuleProviderCompat.toKtLintRuleProvider130(): RuleProvider {
  return RuleProvider { RuleCompat130(createNewRuleInstance()) }
}
