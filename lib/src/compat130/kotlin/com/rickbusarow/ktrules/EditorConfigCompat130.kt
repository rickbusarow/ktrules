...
/** */
class EditorConfigCompat130(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty130()]
  }
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty130(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty130
