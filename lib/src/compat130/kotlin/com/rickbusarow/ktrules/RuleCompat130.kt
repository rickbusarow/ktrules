...
/** */
class RuleCompat130(private val ruleCompat: RuleCompat) :
  Rule(
    ...
    usesEditorConfigProperties = ruleCompat.usesEditorConfigProperties
      .mapToSet { shimProperty -> shimProperty.toKtLintProperty130() }
  ) {

  override fun beforeFirstNode(editorConfig: EditorConfig) {
    ruleCompat.beforeFirstNode(EditorConfigCompat130(editorConfig))
