...
/** */
class EditorConfigCompat160(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty160()]
  }
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty160(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty160
