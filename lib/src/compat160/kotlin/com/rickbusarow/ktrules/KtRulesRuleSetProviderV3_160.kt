...
class KtRulesRuleSetProviderV3_160 : RuleSetProviderV3(RuleSetId(KtRulesRuleSetProvider.ID)) {

  override fun getRuleProviders(): Set<RuleProvider> {

    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider160() }
  }
}

/** */
fun RuleProviderCompat.toKtLintRuleProvider160(): RuleProvider {
  return RuleProvider { RuleCompat160(createNewRuleInstance()) }
}
