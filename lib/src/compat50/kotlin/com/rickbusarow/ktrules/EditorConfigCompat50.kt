...
/** @since 1.1.1 */
class EditorConfigCompat50(private val delegate: EditorConfig) : EditorConfigCompat {
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty50(): KtLintEditorConfigProperty<T> {
