...
/** @since 1.1.1 */
class RuleCompat50(private val ruleCompat: RuleCompat) : Rule(
  ...
  usesEditorConfigProperties = ruleCompat.usesEditorConfigProperties
    .mapToSet { shimProperty -> shimProperty.toKtLintProperty50() }
) {

  override fun beforeFirstNode(editorConfig: EditorConfig) {
    ruleCompat.beforeFirstNode(EditorConfigCompat50(editorConfig))
