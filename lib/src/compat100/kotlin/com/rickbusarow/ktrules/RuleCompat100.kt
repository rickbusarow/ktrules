...
/** @since 1.1.1 */
class RuleCompat100(private val ruleCompat: RuleCompat) : Rule(
  ...
  usesEditorConfigProperties = ruleCompat.usesEditorConfigProperties
    .mapToSet { shimProperty -> shimProperty.toKtLintProperty100() }
) {

  override fun beforeFirstNode(editorConfig: EditorConfig) {
    ruleCompat.beforeFirstNode(EditorConfigCompat100(editorConfig))
