...
/** @since 1.1.1 */
class EditorConfigCompat100(private val delegate: EditorConfig) : EditorConfigCompat {
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty100(): KtLintEditorConfigProperty<T> {
