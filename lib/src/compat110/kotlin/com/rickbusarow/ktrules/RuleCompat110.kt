...
/** @since 1.1.1 */
class RuleCompat110(private val ruleCompat: RuleCompat) :
  Rule(
    ...
    usesEditorConfigProperties = ruleCompat.usesEditorConfigProperties
      .mapToSet { shimProperty -> shimProperty.toKtLintProperty110() }
  ) {

  override fun beforeFirstNode(editorConfig: EditorConfig) {
    ruleCompat.beforeFirstNode(EditorConfigCompat110(editorConfig))
