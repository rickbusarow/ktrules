...
/** @since 1.1.1 */
class EditorConfigCompat110(private val delegate: EditorConfig) : EditorConfigCompat {
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty110(): KtLintEditorConfigProperty<T> {
