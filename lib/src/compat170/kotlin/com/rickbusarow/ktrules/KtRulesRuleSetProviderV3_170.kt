...
class KtRulesRuleSetProviderV3_170 : RuleSetProviderV3(RuleSetId(KtRulesRuleSetProvider.ID)) {

  override fun getRuleProviders(): Set<RuleProvider> {

    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider170() }
  }
}

/** */
fun RuleProviderCompat.toKtLintRuleProvider170(): RuleProvider {
  return RuleProvider { RuleCompat170(createNewRuleInstance()) }
}
