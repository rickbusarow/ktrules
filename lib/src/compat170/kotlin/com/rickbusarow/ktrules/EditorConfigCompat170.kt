...
/** */
class EditorConfigCompat170(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty170()]
  }
...
/** @since 1.1.1 */
fun <T> EditorConfigProperty<T>.toKtLintProperty170(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty170
