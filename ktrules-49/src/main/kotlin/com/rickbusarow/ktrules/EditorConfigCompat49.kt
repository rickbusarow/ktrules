...
/** @since 1.1.1 */
public class EditorConfigCompat49(private val delegate: EditorConfig) : EditorConfigCompat {
...
/** @since 1.1.1 */
public fun <T> EditorConfigProperty<T>.toKtLintProperty49(): KtLintEditorConfigProperty<T> {
