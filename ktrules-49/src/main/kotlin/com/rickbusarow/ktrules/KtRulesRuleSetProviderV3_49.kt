...
public class KtRulesRuleSetProviderV3_49 : RuleSetProviderV3(RuleSetId(KtRulesRuleSetProvider.ID)) {
...
/** @since 1.1.1 */
public fun RuleProviderCompat.toKtLintRuleProvider49(): RuleProvider {
