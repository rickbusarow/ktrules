...
/** @since 1.1.1 */
public class EditorConfigCompat110(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty110()]
  }
...
/** @since 1.1.1 */
public fun <T> EditorConfigProperty<T>.toKtLintProperty110(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty110
