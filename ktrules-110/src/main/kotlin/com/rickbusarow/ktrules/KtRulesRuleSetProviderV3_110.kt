...
public class KtRulesRuleSetProviderV3_110 : RuleSetProviderV3(
  RuleSetId(KtRulesRuleSetProvider.ID)
) {

  override fun getRuleProviders(): Set<RuleProvider> {

    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider110() }
  }
}

/** @since 1.1.1 */
public fun RuleProviderCompat.toKtLintRuleProvider110(): RuleProvider {
  return RuleProvider { RuleCompat110(createNewRuleInstance()) }
}
