 ...
 * @since 1.1.0
 */
fun mustRunAfter(ruleId: RuleId): VisitorModifierCompat.RunAfterRuleCompat =
  VisitorModifierCompat.RunAfterRuleCompat(
    ruleId,
    VisitorModifierCompat.RunAfterRuleCompat.ModeCompat.REGARDLESS_WHETHER_RUN_AFTER_RULE_IS_LOADED_OR_DISABLED
  )
 ...
 * @since 1.1.0
 */
fun dependsOn(ruleId: RuleId): VisitorModifierCompat.RunAfterRuleCompat =
  VisitorModifierCompat.RunAfterRuleCompat(
    ruleId,
    VisitorModifierCompat.RunAfterRuleCompat.ModeCompat.ONLY_WHEN_RUN_AFTER_RULE_IS_LOADED_AND_ENABLED
  )
