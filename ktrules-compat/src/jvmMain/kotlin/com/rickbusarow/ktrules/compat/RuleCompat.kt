...
expect abstract class RuleCompat(
  /**
   ...
   */
  visitorModifiers: Set<VisitorModifierCompat> = setOf(),
   ...
   */
  usesEditorConfigProperties: Set<EditorConfigProperty<*>> = setOf()
) {
   ...
   */
  open fun beforeFirstNode(editorConfigProperties: EditorConfigCompat)
