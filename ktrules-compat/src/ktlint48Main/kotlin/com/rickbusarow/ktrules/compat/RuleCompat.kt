...
import com.rickbusarow.ktrules.compat.RuleCompat.VisitorModifierCompat
...
actual abstract class RuleCompat actual constructor(
  ...
  override val editorConfigProperties: List<KtLintEditorConfigProperty<*>> by lazy {
    usesEditorConfigProperties.map { it.toKtLintProperty48() }
  }
  ...
  override fun beforeFirstNode(editorConfigProperties: EditorConfigProperties) {
    beforeFirstNode(EditorConfigCompat48(editorConfigProperties))
