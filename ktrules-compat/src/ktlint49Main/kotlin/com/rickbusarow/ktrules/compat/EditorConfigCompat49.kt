...
/** */
fun <T> EditorConfigProperty<T>.toKtLintProperty49(): com.pinterest.ktlint.rule.engine.core.api.editorconfig.EditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty49

  return com.pinterest.ktlint.rule.engine.core.api.editorconfig.EditorConfigProperty(
...
private fun CodeStyleValue.toCompatCodeStyleValueCompat(): CodeStyleValueCompat =
  when (this) {
    CodeStyleValue.android -> CodeStyleValueCompat.android
    CodeStyleValue.android_studio -> CodeStyleValueCompat.android_studio
    CodeStyleValue.intellij_idea -> CodeStyleValueCompat.intellij_idea
    CodeStyleValue.ktlint_official -> CodeStyleValueCompat.ktlint_official
    CodeStyleValue.official -> CodeStyleValueCompat.official
  }
