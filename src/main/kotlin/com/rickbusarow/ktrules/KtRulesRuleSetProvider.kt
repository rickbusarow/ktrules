...
class KtRulesRuleSetProvider : RuleSetProviderV2(
  ...
  override fun getRuleProviders(): Set<RuleProvider> {
    return setOf(
      ...
      RuleProvider {
        val version = requireNotNull(System.getProperty("ktrules.current_version")) {
          "${NoSinceInKDocRule::class.java.simpleName} requires a version " +
            "to be set as a System property with a name of 'ktrules.current_version'. "
        }
        NoSinceInKDocRule(version)
      },
