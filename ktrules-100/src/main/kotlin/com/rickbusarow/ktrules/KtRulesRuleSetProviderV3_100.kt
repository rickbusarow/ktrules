...
public class KtRulesRuleSetProviderV3_100 : RuleSetProviderV3(
  ...
  override fun getRuleProviders(): Set<RuleProvider> {
    ...
    return KtRulesRuleSetProvider.getRuleProviders()
      .mapToSet { it.toKtLintRuleProvider100() }
  }
}

/** @since 1.1.1 */
public fun RuleProviderCompat.toKtLintRuleProvider100(): RuleProvider {
  return RuleProvider { RuleCompat100(createNewRuleInstance()) }
}
