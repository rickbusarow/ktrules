...
/** @since 1.1.1 */
public class EditorConfigCompat100(private val delegate: EditorConfig) : EditorConfigCompat {
  override fun <T> get(editorConfigProperty: EditorConfigProperty<T>): T {
    return delegate[editorConfigProperty.toKtLintProperty100()]
  }
...
/** @since 1.1.1 */
public fun <T> EditorConfigProperty<T>.toKtLintProperty100(): KtLintEditorConfigProperty<T> {
  val editorConfigProperty = this@toKtLintProperty100
