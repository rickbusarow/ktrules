...
/** @since 1.1.1 */
public object KtRulesRuleSetProvider {
  ...
  public object About {
    ...
    /** @since 1.1.1 */
    public const val MAINTAINER: String = "Rick Busarow"

    /** @since 1.1.1 */
    public const val DESCRIPTION: String = "miscellaneous Ktlint rules"

    /** @since 1.1.1 */
    public const val LICENSE: String = "Apache 2.0"

    /** @since 1.1.1 */
    public const val REPOSITORY_URL: String = "https://www.github.com/rickbusarow/ktrules"

    /** @since 1.1.1 */
    public const val ISSUE_TRACKER_URL: String = "https://www.github.com/rickbusarow/ktrules/issues"
  }

  /** @since 1.1.1 */
  public const val ID: String = "kt-rules"

  /** @since 1.1.1 */
  public fun getRuleProviders(): Set<RuleProviderCompat> = setOf(
