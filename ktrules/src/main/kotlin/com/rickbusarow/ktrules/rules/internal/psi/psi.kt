 ...
 * @since 1.1.0
 */
internal fun PsiElement.createFileFromText(
  text: String
): KtFile = ktPsiFactory().createFileFromText(text)
 ...
 * @since 1.1.1
 */
internal fun KtPsiFactory.createFileFromText(text: String): KtFile = createFile("tmp.kt", text)
 ...
 * @since 1.1.0
 */
internal fun PsiElement?.isKDocTag(): Boolean {
 ...
 * @since 1.1.0
 */
internal fun KtCallElement.getCallNameExpression(): KtSimpleNameExpression? {
 ...
 * @since 1.1.0
 */
internal fun KtNamedDeclaration.getValueParameters(): List<KtParameter> {
 ...
 * @since 1.1.0
 */
internal fun KtNamedDeclaration.getValueParameterList(): KtParameterList? {
  return when (this) {
 ...
 * @since 1.1.0
 */
internal inline fun <reified T : PsiElement> PsiElement.getChildOfType(): T? {
  return PsiTreeUtil.getChildOfType(this, T::class.java)
}

/** @since 1.1.1 */
internal inline fun <T : PsiElement> T.removeAllChildren(
...
/** @since 1.2.0 */
internal fun PsiElement.replaceChild(newChild: PsiElement, oldChild: PsiElement) {
