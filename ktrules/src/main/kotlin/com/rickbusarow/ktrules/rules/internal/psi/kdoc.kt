 ...
 * @since 1.1.1
 */
internal val KDoc.leadingAteriskIndent: String get() = fileIndent(additionalOffset = 1)
 ...
 * @since 1.1.1
 */
internal val KDoc.starIndent: String get() = fileIndent(additionalOffset = 1)

/** @since 1.1.1 */
internal fun KDoc.makeMultiline(): KDoc = apply {
...
/** @since 1.1.1 */
internal fun KDocTag.replaceContentWithNewPsiFromText(newText: String): KDocTag = apply {
...
/** @since 1.1.1 */
internal fun KtPsiFactory.createKDocTagFromText(
  newText: String,
...
/** @since 1.1.1 */
internal fun KtPsiFactory.createKDoc(
