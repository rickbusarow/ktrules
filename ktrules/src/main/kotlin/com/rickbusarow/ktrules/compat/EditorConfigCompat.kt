 ...
 * @since 1.1.1
 */
public interface EditorConfigCompat {
   ...
   * @since 1.1.1
   */
  public fun <T> getEditorConfigValueOrNull(propertyType: PropertyType<T>, propertyName: String): T?
   ...
   * @since 1.1.1
   */
  public fun contains(propertyName: String): Boolean
