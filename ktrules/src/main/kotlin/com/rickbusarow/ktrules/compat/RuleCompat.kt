 ...
 * @since 1.1.1
 */
public fun interface RuleProviderCompat {
  /**
   * Creates a new [RuleCompat]
   *
   * @since 1.1.1
   */
  public fun createNewRuleInstance(): RuleCompat
}
...
public abstract class RuleCompat(
  /**
   ...
   * @since 1.1.1
   */
  public val visitorModifiers: Set<RuleCompat.VisitorModifierCompat> = emptySet(),
   ...
   * @since 1.1.1
   */
  public open fun beforeFirstNode(editorConfig: EditorConfigCompat) {}
  ...
  /** @since 1.1.1 */
  public sealed class VisitorModifierCompat {
    /**
     ...
     */
    @Poko
    public class RunAfterRuleCompat(
      /**
       ...
       * @since 1.1.1
       */
      public val mode: ModeCompat
    ) : VisitorModifierCompat() {
      /** @since 1.1.1 */
      public enum class ModeCompat {
        /**
    ...
    /** @since 1.1.1 */
    public object RunAsLateAsPossibleCompat : VisitorModifierCompat()
  }
}
...
@JvmInline
public value class RuleId(public val value: String) : java.io.Serializable
