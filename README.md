...
<!--doks maven-artifact:3, current-ktlint-version:1-->

```kotlin
// build.gradle.kts
dependencies {
  // Using the current KtLint (0.49.1) apis
  ktlint("com.rickbusarow.ktrules:ktrules:1.1.1")

  // ... or using the KtLint 0.48.x apis
  ktlint("com.rickbusarow.ktrules:ktrules-48:1.1.1")

  // ... or using the KtLint 0.47.x apis
  ktlint("com.rickbusarow.ktrules:ktrules-47:1.1.1")
}
```
