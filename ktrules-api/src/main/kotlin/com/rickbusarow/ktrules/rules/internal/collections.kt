 ...
 * @since 1.1.1
 */
public inline fun <T, R : Any> Iterable<T>.singleNotNullOf(transform: (T) -> R?): R {
 ...
 * @since 1.1.1
 */
public inline fun <C : Iterable<T>, T, R> C.mapToSet(
 ...
 * @since 1.1.1
 */
public fun <T, R : Any> Sequence<T>.singleNotNullOf(transform: (T) -> R?): R {
  return mapNotNull(transform).single()
}
 ...
 * @since 1.1.1
 */
public fun <T : Any> sequenceOfNotNull(vararg elements: T?): Sequence<T> =
 ...
 * @since 1.1.1
 */
public inline fun <C, R> C?.ifNullOrEmpty(defaultValue: () -> R): R where R : Collection<*>,
                                                                          C : R {
 ...
 * @since 1.1.1
 */
public fun <T> Sequence<T>.stateful(): Sequence<T> {
